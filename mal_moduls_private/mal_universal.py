...
def min_and_max_values(df, *, nmb=3, prec=2, max_lng=11, row_center=None, shorten=False):
    ...
    row_center: list, str, series or None
        name of record(s) that will be shown in middle, or separate series with identical columns. If you use series than there have not to be a record with the same name in the dataframe. If None, there will be shown nothing.
    shorten: bool
